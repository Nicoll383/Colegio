@echo off
echo ================================================
echo   Sistema de Matriculas Escolar - Instalacion
echo ================================================
echo.

echo Paso 1: Instalando dependencias del proyecto raiz...
call npm install
echo Dependencias del proyecto raiz instaladas
echo.
...
echo ================================================
echo.
echo Antes de continuar, asegurese de:
echo 1. Tener MySQL instalado y en ejecucion
echo 2. Tener MongoDB instalado y en ejecucion
echo 3. Crear la base de datos MySQL: 'sistema_matriculas'
echo.
echo Comandos sugeridos:
echo   MySQL: mysql -u root -p -e "CREATE DATABASE sistema_matriculas;"
echo   MongoDB: Ya crea la base de datos automaticamente
echo.

set /p continue="Las bases de datos estan configuradas? (s/n): "
if /i "%continue%"=="s" (
    echo.
